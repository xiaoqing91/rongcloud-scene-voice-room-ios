...
@interface RCRefreshStateHeader()
{
...
@implementation RCRefreshStateHeader
#pragma mark - 懒加载子控件
...
- (void)placeSubviews
{
    ...
    CGFloat space = self.mj_h > MJRefreshHeaderHeight ? self.mj_h - MJRefreshHeaderHeight : 0;
    
    CGFloat stateLabelH = 20;
    self.stateLabel.mj_y = space + 4;
    self.stateLabel.mj_h = stateLabelH;
    self.lastUpdatedTimeLabel.mj_y = CGRectGetMaxY(self.stateLabel.frame) + 6;
    ...
    CGFloat arrowCenterY = space + MJRefreshHeaderHeight * 0.5;
