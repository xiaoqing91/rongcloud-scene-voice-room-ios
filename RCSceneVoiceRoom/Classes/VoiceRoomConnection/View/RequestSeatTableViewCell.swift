//
//  RequestSeatTableViewCell.swift
//  RCE
//
...
class RequestSeatTableViewCell: UITableViewCell, Reusable {
    ...
    var acceptCallback:((String) -> Void)?
    ...
    func updateCell(user: RCSceneRoomUser) {
        userId = user.userId
